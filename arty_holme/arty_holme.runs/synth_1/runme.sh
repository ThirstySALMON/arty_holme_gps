...
HD_PWD='C:/Users/OIE/Desktop/arty_holme_gps/arty_holme/arty_holme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Frac7_GPS_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Frac7_GPS_top.tcl
