...
HD_PWD='C:/Users/OIE/Desktop/arty_holme_gps/arty_holme/arty_holme.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Frac7_GPS_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Frac7_GPS_top.tcl -notrace
