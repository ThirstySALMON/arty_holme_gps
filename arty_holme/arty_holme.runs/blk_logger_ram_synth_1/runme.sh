...
HD_PWD='C:/Users/OIE/Desktop/arty_holme_gps/arty_holme/arty_holme.runs/blk_logger_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_logger_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_logger_ram.tcl
